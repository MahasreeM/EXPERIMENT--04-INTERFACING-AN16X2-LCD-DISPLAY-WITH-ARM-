...
int main(void)
{
  ...
  Lcd_cursor(&lcd, 0, 1);
  Lcd_string(&lcd, "M.MAHA SHREE");
  Lcd_cursor(&lcd, 1, 1);
  Lcd_string(&lcd, "212224110035");
...
## Output screen shots of proteus  :
 ![pmc exp4](https://github.com/user-attachments/assets/56e50000-b601-4701-9952-dab64c5edc17)


 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 ![Screenshot (193)](https://github.com/user-attachments/assets/8bea73c0-9b7d-4261-acdc-840a337bac8e)
